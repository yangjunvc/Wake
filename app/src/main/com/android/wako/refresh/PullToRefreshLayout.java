package com.android.wako.refresh;
...
/**
 * 自定义的通用上拉刷新，下拉加载布局，用来管理三个子控件，其中一个是下拉头，一个是包含内容的pullableView（可以是实现Pullable接口的的任何View），
 * 还有一个上拉头
 * 
 */
public class PullToRefreshLayout extends RelativeLayout
{
	 ...
	 * 设置是否能下拉刷新
	 */
	public boolean mCanDown = true;
	/**
     * 设置是否能上拉加载,默认false
     */
	public boolean mCanPull = false;
	...
	private void initView(Context context)
	{
		...
		rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.refresh_reverse_anim);
		refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
				context, R.anim.refresh_rotating);
		// 添加匀速转动动画
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		if (!isLayout)
		{
			...
			loadmoreDist = ((ViewGroup) loadmoreView).getChildAt(0)
					.getMeasuredHeight();
            refreshView.layout(0, (int) (pullDownY + pullUpY) - refreshView.getMeasuredHeight(), refreshView.getMeasuredWidth(),
