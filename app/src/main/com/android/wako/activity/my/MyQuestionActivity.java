...
import com.android.wako.adapter.QuestionAdapter;
import com.android.wako.common.Constants;
import com.android.wako.json.MyQuestionJson;
 ...
 */
public class MyQuestionActivity extends CommonTitleActivity{
    private static final int REQUEST_LIST = 10012;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList = new ArrayList<QuestionModel>();
    ...
    private void getListData() {
        ...
        startHttpRequst(Constants.HTTP_POST, Constants.MYQUESTION_LIST, parameter, false, REQUEST_LIST, true, false);
    }
    ...
    private void initViews() {
        ...
        mPtrl.setOnRefreshListener(new PullToRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(PullToRefreshLayout pullToRefreshLayout) {
                if (SystemInfoUtil.isNetworkConnected(MyQuestionActivity.this)) {
                    page = 0;
                    getListData();
                } else {
            ...
            public void onLoadMore(PullToRefreshLayout pullToRefreshLayout) {
                if (page < totalPage && SystemInfoUtil.isNetworkConnected(MyQuestionActivity.this)) {
                    getListData();
                }else{
                    if(!SystemInfoUtil.isNetworkConnected(MyQuestionActivity.this)){
                        showToast(R.string.network_error);
        ...
        switch (code){
            case REQUEST_LIST:
                if(resStatus == ResStatus.Success){
                        MyQuestionJson json = gson.fromJson(resultJson, MyQuestionJson.class);
